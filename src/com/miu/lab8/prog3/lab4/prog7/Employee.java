...
//	}
	...
	public int compareTo(Employee o) {
		double largestAmount = accounts.getLargest().getBalance();
		double employeeAmount  = o.accounts.getLargest().getBalance();
		if(largestAmount == employeeAmount) return 0;
		else if (largestAmount > employeeAmount) return 1;
		else return -1;
