...
//    }
    ...
    void addCD(String cdId) {
        //implement-- redo the implementation
        directory.addNewCD(parseInt(cdId));
    ...
    void checkIfBookIsInStock(String bookId) {
        //implement-- redo the implementation
        boolean bookFound = directory.bookIsInStock(bookId);
        if (bookFound)
    ...
    void checkWhetherFoodItemInMarket(String foodItem) {
        //	implement-- redo the implementation
        boolean foodFound = directory.marketCarriesFoodItem(foodItem);
        if (foodFound) {
            System.out.println("Yes the market carries " + foodItem + n + CONTINUE);
        }else{
            System.out.println("Sorry the market doesn't carry " + foodItem + n + CONTINUE);
        }
